...
// Structure of the MCP251XFD used in the EXT1 in the demo
#define MCP251XFD_EXT1_OSCCLK  ( 40000000 ) // The MCP251XFD on the EXT1 interface is at 40MHz
extern MCP251XFD MCP251XFD_Ext1;
#define CANEXT1  &MCP251XFD_Ext1

// Structure of the MCP251XFD configuration used in the EXT1 in the demo
...
// Structure of the MCP251XFD FIFO configuration used in the EXT1 in the demo
#define MCP2517FD_EXT1_FIFO_COUNT    1
extern MCP251XFD_FIFO MCP2517FD_Ext1_FIFOlist[MCP2517FD_EXT1_FIFO_COUNT];

// Structure of the MCP251XFD filters configuration used in the EXT1 in the demo
...
#define EXT1_GPIO0_Low   MCP251XFD_SetGPIOPinsOutputLevel(CANEXT1, MCP251XFD_GPIO0_LOW , MCP251XFD_GPIO0_Mask)
#define EXT1_GPIO0_High  MCP251XFD_SetGPIOPinsOutputLevel(CANEXT1, MCP251XFD_GPIO0_HIGH, MCP251XFD_GPIO0_Mask)

#define EXT1_GPIO1_Low   MCP251XFD_SetGPIOPinsOutputLevel(CANEXT1, MCP251XFD_GPIO1_LOW , MCP251XFD_GPIO1_Mask)
#define EXT1_GPIO1_High  MCP251XFD_SetGPIOPinsOutputLevel(CANEXT1, MCP251XFD_GPIO1_HIGH, MCP251XFD_GPIO1_Mask)
