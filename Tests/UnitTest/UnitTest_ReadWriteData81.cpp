...
namespace UnitTest_BufSize81
{
  ...
  public:
    ...
    TEST_METHOD(TestMethod_MCP251XFD_ReadData_CRCREAD)
    {
      ...
      Assert::AreEqual(ERR__OUT_OF_RANGE, Error, L"Test {size=1; RAM}, should be MCR_OUT_OF_RANGE"); // Check the return value
      ...
      Assert::AreEqual(ERR__OUT_OF_RANGE, Error, L"Test {size=BUFlimit+1; RAM}, should be MCR_OUT_OF_RANGE");  // Check the return value
    ...
    TEST_METHOD(TestMethod_MCP251XFD_WriteData_SAFEWRITE)
    {
      ...
      Assert::AreEqual(ERR__OUT_OF_RANGE, Error, L"Test {size=5; RAM}, should be MCR_OUT_OF_RANGE"); // Check the return value
